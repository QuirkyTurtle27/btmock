...
public class PaymentOutcomeSimulator {
	...
	public boolean simulateByOrderNumber(String orderNumber, String pan, String expiry, String cvv,
	...
	private boolean applyOutcome(OrderEntity order, String pan, String expiryRaw, String cvv, String cardholderName) {
		...
		boolean success = (outcome == CardOutcomeEnum.SUCCESS);
		...
		log.debugf("Payment simulation applied: orderId=%s, status=%s, actionCode=%s", order.orderId, order.orderStatus,
				order.actionCode);
